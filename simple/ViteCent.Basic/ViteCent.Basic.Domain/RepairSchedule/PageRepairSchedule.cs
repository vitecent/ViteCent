...
public class PageRepairSchedule(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : BaseDomain<RepairScheduleEntity>, IRequestHandler<SearchRepairScheduleEntityArgs, List<RepairScheduleEntity>>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
