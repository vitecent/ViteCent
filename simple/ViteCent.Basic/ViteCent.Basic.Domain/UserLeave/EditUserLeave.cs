...
/// <summary>
/// 编辑请假申请领域服务类 </summary> <remarks> 该类负责处理编辑请假申请的业务逻辑，包括：
/// 1. 记录操作日志
/// 2. 调用基类方法更新请假申请
...
public class EditUserLeave(
    ...
    : BaseDomain<UserLeaveEntity>, IRequestHandler<UserLeaveEntity, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
    ...
    /// <summary>
    /// 处理编辑请假申请的请求 </summary> <param name="request">包含更新信息的请假申请模型</param> <param
