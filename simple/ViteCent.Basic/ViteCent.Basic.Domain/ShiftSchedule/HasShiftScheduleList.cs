...
public class HasShiftScheduleList(ILogger<HasShiftScheduleList> logger) : BaseDomain<ShiftScheduleEntity>, IRequestHandler<HasShiftScheduleEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
