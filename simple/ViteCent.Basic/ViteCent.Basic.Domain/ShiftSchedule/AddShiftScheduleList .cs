...
public class AddShiftScheduleList(ILogger<AddShiftScheduleList> logger) : BaseDomain<AddShiftScheduleEntity>, IRequestHandler<AddShiftScheduleEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
