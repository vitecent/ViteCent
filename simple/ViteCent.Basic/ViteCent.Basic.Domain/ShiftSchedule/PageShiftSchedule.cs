...
public class PageShiftSchedule(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : BaseDomain<ShiftScheduleEntity>, IRequestHandler<SearchShiftScheduleEntityArgs, List<ShiftScheduleEntity>>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
