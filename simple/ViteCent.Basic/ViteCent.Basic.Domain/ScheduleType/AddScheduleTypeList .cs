...
public class AddScheduleTypeList(ILogger<AddScheduleTypeList> logger) : BaseDomain<AddScheduleTypeEntity>, IRequestHandler<AddScheduleTypeEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
