...
/// <summary>
/// 编辑排班信息领域服务类 </summary> <remarks> 该类负责处理编辑排班信息的业务逻辑，包括：
/// 1. 记录操作日志
/// 2. 调用基类方法更新排班信息
...
public class EditSchedule(
    ...
    : BaseDomain<ScheduleEntity>, IRequestHandler<ScheduleEntity, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
    ...
    /// <summary>
    /// 处理编辑排班信息的请求 </summary> <param name="request">包含更新信息的排班信息模型</param> <param
