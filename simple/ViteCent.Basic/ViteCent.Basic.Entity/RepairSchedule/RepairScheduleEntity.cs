...
public class RepairScheduleEntity : BaseEntity, IRequest<BaseResult>
{
    /// <summary>
    /// 公司标识
    /// </summary>
    ...
    /// 补卡时间
    /// </summary>
    [SugarColumn(ColumnName = "repairTime", ColumnDataType = "datetime", ColumnDescription = "补卡时间")]
    public DateTime RepairTime { get; set; }

    /// <summary>
    /// 补卡类型
    /// </summary>
    [SugarColumn(ColumnName = "repairType", ColumnDataType = "int", Length = 11, ColumnDescription = "补卡类型")]
    ...
    /// 排班名称
    /// </summary>
    [SugarColumn(ColumnName = "scheduleName", ColumnDataType = "varchar", Length = 50, IsNullable = true, ColumnDescription = "排班名称")]
