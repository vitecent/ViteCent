...
public partial class AddAttendance(ILogger<AddAttendance> logger, 
    IBaseCache cache,
    IMapper mapper,
    IMediator mediator,
    ...
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<AddAttendanceArgs, BaseResult>
{
    /// <summary>
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<BaseResult> Handle(AddAttendanceArgs request, CancellationToken cancellationToken)
    {
        logger.LogInformation("Invoke ViteCent.Basic.Application.Attendance.AddAttendance");
        ...
        var entity = mapper.Map<AddAttendanceEntity>(request);
