...
public partial class EditAttendance(ILogger<EditAttendance> logger, 
    IMapper mapper, 
    IMediator mediator, 
    ...
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<EditAttendanceArgs, BaseResult>
{
    /// <summary>
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<BaseResult> Handle(EditAttendanceArgs request, CancellationToken cancellationToken)
    {
        logger.LogInformation("Invoke ViteCent.Basic.Application.Attendance.EditAttendance");
