...
public partial class AddRepairAttendance(ILogger<AddRepairAttendance> logger, 
    IBaseCache cache,
    IMapper mapper,
    IMediator mediator,
    ...
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<AddRepairAttendanceArgs, BaseResult>
{
    /// <summary>
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<BaseResult> Handle(AddRepairAttendanceArgs request, CancellationToken cancellationToken)
    {
        logger.LogInformation("Invoke ViteCent.Basic.Application.RepairAttendance.AddRepairAttendance");
        ...
        var entity = mapper.Map<AddRepairAttendanceEntity>(request);
