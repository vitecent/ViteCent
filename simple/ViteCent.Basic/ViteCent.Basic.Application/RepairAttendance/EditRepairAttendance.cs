...
public partial class EditRepairAttendance(ILogger<EditRepairAttendance> logger, 
    IMapper mapper, 
    IMediator mediator, 
    ...
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<EditRepairAttendanceArgs, BaseResult>
{
    /// <summary>
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<BaseResult> Handle(EditRepairAttendanceArgs request, CancellationToken cancellationToken)
    {
        logger.LogInformation("Invoke ViteCent.Basic.Application.RepairAttendance.EditRepairAttendance");
