...
public partial class AddBaseTable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var hasListArgs = new HasBaseTableEntityListArgs
        {
    ...
    /// <param name="cancellationToken">取消令牌</param>
    /// <returns>处理结果</returns>
    private async Task<BaseResult> OverrideHandle(AddBaseTableArgs request,
        CancellationToken cancellationToken)
    {
        var companyId = user?.Company?.Id ?? string.Empty;
