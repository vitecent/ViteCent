...
public partial class AddBaseTable(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : IRequestHandler<AddBaseTableArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    public async Task<BaseResult> Handle(AddBaseTableArgs request,
        CancellationToken cancellationToken)
    {
        // 记录方法调用日志，便于追踪和调试
        logger.LogInformation("Invoke ViteCent.Database.Application.BaseTable.AddBaseTable");
        ...
        var entity = mapper.Map<AddBaseTableEntity>(request);
