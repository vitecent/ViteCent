...
public class AddBaseFieldList(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : IRequestHandler<AddBaseFieldListArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    public async Task<BaseResult> Handle(AddBaseFieldListArgs request,
        CancellationToken cancellationToken)
    {
        ...
        var entitys = new AddBaseFieldEntityListArgs()
        {
            Items = []
        };
        ...
        foreach (var item in request.Items)
        {
            ...
            var entity = mapper.Map<AddBaseFieldEntity>(item);
        ...
        foreach (var entity in entitys.Items)
            await AddBaseField.OverrideTopic(mediator, TopicEnum.Add, entity, cancellationToken);
