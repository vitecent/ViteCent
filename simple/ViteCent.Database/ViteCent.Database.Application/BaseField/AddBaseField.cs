...
public partial class AddBaseField(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : IRequestHandler<AddBaseFieldArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    public async Task<BaseResult> Handle(AddBaseFieldArgs request,
        CancellationToken cancellationToken)
    {
        // 记录方法调用日志，便于追踪和调试
        logger.LogInformation("Invoke ViteCent.Database.Application.BaseField.AddBaseField");
        ...
        var entity = mapper.Map<AddBaseFieldEntity>(request);
