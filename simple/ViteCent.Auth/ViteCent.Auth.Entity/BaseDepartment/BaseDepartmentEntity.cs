...
public class BaseDepartmentEntity : BaseEntity, IRequest<BaseResult>
{
    ...
    /// 负责人
    /// </summary>
    [SugarColumn(ColumnName = "manager", ColumnDataType = "varchar", Length = 50, IsNullable = true, ColumnDescription = "负责人")]
    public string? Manager { get; set; }

    /// <summary>
    /// 负责人电话
    /// </summary>
    [SugarColumn(ColumnName = "managerPhone", ColumnDataType = "varchar", Length = 50, IsNullable = true, ColumnDescription = "负责人电话")]
