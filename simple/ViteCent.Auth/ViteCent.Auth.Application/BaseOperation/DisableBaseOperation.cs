...
public partial class DisableBaseOperation(ILogger<DisableBaseOperation> logger,
    IMapper mapper,
    IMediator mediator,
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<DisableBaseOperationArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
