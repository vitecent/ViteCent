...
public class AddBaseOperationList(
    ...
    : IRequestHandler<AddBaseOperationListArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<BaseResult> Handle(AddBaseOperationListArgs request,
        CancellationToken cancellationToken)
    {
        ...
        foreach (var entity in entitys.Items)
            await AddBaseOperation.OverrideTopic(mediator, TopicEnum.Add, entity, cancellationToken);
