...
public class PageBasePosition(ILogger<PageBasePosition> logger,
    IMapper mapper,
    IMediator mediator,
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<SearchBasePositionArgs, PageResult<BasePositionResult>>
{
    /// <summary>
    /// 用户信息
    /// </summary>
