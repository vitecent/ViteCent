...
public partial class EditBasePosition(ILogger<EditBasePosition> logger,
    IMapper mapper,
    IMediator mediator,
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<EditBasePositionArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
