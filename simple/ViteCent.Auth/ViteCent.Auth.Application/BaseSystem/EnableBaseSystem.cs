...
public partial class EnableBaseSystem(ILogger<EnableBaseSystem> logger,
    IMapper mapper,
    IMediator mediator,
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<EnableBaseSystemArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
