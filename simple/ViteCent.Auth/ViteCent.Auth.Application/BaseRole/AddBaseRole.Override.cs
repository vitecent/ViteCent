...
public partial class AddBaseRole
{
    ...
    internal static async Task<BaseResult> OverrideHandle(IMediator mediator, AddBaseRoleListArgs request,
    ...
    /// <param name="cancellationToken">取消令牌</param>
    /// <returns>处理结果</returns>
    internal static async Task OverrideTopic(IMediator mediator, TopicEnum topic, BaseRoleEntity entity,
