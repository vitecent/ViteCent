...
public partial class DisableBaseUser(ILogger<DisableBaseUser> logger,
    IMapper mapper,
    IMediator mediator,
    IHttpContextAccessor httpContextAccessor) : IRequestHandler<DisableBaseUserArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
