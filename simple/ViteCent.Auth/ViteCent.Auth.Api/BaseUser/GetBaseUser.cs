...
// 设置路由前缀
[Route("BaseUser")]
public partial class GetBaseUser(
    // 注入日志记录器
    ...
    IMediator mediator)
    // 继承基类，指定查询参数和返回结果类型
    : BaseApi<GetBaseUserArgs, DataResult<BaseUserResult>>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    /// 4. 返回查询结果
    /// </remarks>
    /// <param name="args">查询参数，包含获取用户信息所需的条件</param>
    /// <returns>返回包含用户信息的数据结果对象</returns>
