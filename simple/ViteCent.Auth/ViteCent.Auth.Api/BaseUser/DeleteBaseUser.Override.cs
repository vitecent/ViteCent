...
/// 删除用户信息接口拓展
/// </summary>
/// <remarks>该部分类主要负责处理删除用户信息信息时的自定义逻辑</remarks>
public partial class DeleteBaseUser
{
    /// <summary>
    /// 验证参数
    /// </summary>
    ...
    private static void OverrideInvoke(DeleteBaseUserArgs args, BaseUserInfo user)
    {
        // 设置公司标识
