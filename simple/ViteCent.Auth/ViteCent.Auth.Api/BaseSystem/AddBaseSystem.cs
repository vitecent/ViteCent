...
[Route("BaseSystem")]
public partial class AddBaseSystem(ILogger<AddBaseSystem> logger, IMediator mediator) : BaseLoginApi<AddBaseSystemArgs, BaseResult>
{
    /// <summary>
    /// </summary>
    ...
    [Route("Add")]
    public override async Task<BaseResult> InvokeAsync(AddBaseSystemArgs args)
    {
