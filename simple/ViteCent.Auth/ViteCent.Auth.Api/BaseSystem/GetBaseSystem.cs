...
// 设置路由前缀
[Route("BaseSystem")]
public partial class GetBaseSystem(
    // 注入日志记录器
    ...
    IMediator mediator)
    // 继承基类，指定查询参数和返回结果类型
    : BaseApi<GetBaseSystemArgs, DataResult<BaseSystemResult>>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    /// 4. 返回查询结果
    /// </remarks>
    /// <param name="args">查询参数，包含获取系统信息所需的条件</param>
