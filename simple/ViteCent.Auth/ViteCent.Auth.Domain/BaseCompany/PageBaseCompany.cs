...
public class PageBaseCompany(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : BaseDomain<BaseCompanyEntity>, IRequestHandler<SearchBaseCompanyEntityArgs, List<BaseCompanyEntity>>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
    ...
    /// 3. 返回查询结果
    /// </remarks>
    public async Task<List<BaseCompanyEntity>> Handle(SearchBaseCompanyEntityArgs request,
