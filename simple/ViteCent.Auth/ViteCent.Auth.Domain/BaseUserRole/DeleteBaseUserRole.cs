...
public class DeleteBaseUserRole(ILogger<DeleteBaseUserRole> logger) : BaseDomain<DeleteBaseUserRoleEntity>, IRequestHandler<DeleteBaseUserRoleEntity, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
