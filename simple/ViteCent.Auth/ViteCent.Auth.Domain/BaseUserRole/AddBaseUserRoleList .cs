...
public class AddBaseUserRoleList(ILogger<AddBaseUserRoleList> logger) : BaseDomain<AddBaseUserRoleEntity>, IRequestHandler<AddBaseUserRoleEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
