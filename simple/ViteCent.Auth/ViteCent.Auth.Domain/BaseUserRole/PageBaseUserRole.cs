...
public class PageBaseUserRole(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : BaseDomain<BaseUserRoleEntity>, IRequestHandler<SearchBaseUserRoleEntityArgs, List<BaseUserRoleEntity>>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
