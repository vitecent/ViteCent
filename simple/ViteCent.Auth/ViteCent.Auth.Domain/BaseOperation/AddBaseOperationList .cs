...
public class AddBaseOperationList(ILogger<AddBaseOperationList> logger) : BaseDomain<AddBaseOperationEntity>, IRequestHandler<AddBaseOperationEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
