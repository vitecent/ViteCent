...
public class AddBasePositionList(ILogger<AddBasePositionList> logger) : BaseDomain<AddBasePositionEntity>, IRequestHandler<AddBasePositionEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
