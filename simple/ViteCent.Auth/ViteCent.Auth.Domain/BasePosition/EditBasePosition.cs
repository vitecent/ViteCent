...
/// <summary>
/// 编辑职位信息领域服务类 </summary> <remarks> 该类负责处理编辑职位信息的业务逻辑，包括：
/// 1. 记录操作日志
/// 2. 调用基类方法更新职位信息
...
public class EditBasePosition(
    ...
    : BaseDomain<BasePositionEntity>, IRequestHandler<BasePositionEntity, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
    ...
    /// <summary>
    /// 处理编辑职位信息的请求 </summary> <param name="request">包含更新信息的职位信息模型</param> <param
