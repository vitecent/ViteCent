...
public class AddBaseDepartmentList(ILogger<AddBaseDepartmentList> logger) : BaseDomain<AddBaseDepartmentEntity>, IRequestHandler<AddBaseDepartmentEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
