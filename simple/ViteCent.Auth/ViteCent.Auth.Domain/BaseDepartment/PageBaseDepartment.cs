...
public class PageBaseDepartment(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : BaseDomain<BaseDepartmentEntity>, IRequestHandler<SearchBaseDepartmentEntityArgs, List<BaseDepartmentEntity>>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
