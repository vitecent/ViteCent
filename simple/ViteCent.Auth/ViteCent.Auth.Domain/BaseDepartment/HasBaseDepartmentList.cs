...
public class HasBaseDepartmentList(ILogger<HasBaseDepartmentList> logger) : BaseDomain<BaseDepartmentEntity>,
    IRequestHandler<HasBaseDepartmentEntityListArgs, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
