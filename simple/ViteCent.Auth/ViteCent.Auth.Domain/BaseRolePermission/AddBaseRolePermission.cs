...
public class AddBaseRolePermission(ILogger<AddBaseRolePermission> logger) : BaseDomain<AddBaseRolePermissionEntity>, IRequestHandler<AddBaseRolePermissionEntity, BaseResult>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
