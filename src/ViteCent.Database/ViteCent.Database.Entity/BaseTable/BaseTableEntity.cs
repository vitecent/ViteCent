...
/// </summary>
[Serializable]
[SugarTable("base_table")]
public class BaseTableEntity : BaseEntity, IRequest<BaseResult>
{
    /// <summary>
    /// 简称
    /// </summary>
    ...
    /// 分表类型
    /// </summary>
    [SugarColumn(ColumnName = "splitType", ColumnDataType = "varchar", Length = 100, ColumnDescription = "分表类型")]
