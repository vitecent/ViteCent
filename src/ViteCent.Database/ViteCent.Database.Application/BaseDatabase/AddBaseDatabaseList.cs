...
public class AddBaseDatabaseList(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : IRequestHandler<AddBaseDatabaseListArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    public async Task<BaseResult> Handle(AddBaseDatabaseListArgs request,
        CancellationToken cancellationToken)
    {
        ...
        var entitys = new AddBaseDatabaseEntityListArgs()
        {
            Items = []
        };
        ...
        foreach (var item in request.Items)
        {
            ...
            var entity = mapper.Map<AddBaseDatabaseEntity>(item);
        ...
        foreach (var entity in entitys.Items)
            await AddBaseDatabase.OverrideTopic(mediator, TopicEnum.Add, entity, cancellationToken);
