...
public partial class AddBaseDatabase(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : IRequestHandler<AddBaseDatabaseArgs, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    public async Task<BaseResult> Handle(AddBaseDatabaseArgs request,
        CancellationToken cancellationToken)
    {
        // 记录方法调用日志，便于追踪和调试
        logger.LogInformation("Invoke ViteCent.Database.Application.BaseDatabase.AddBaseDatabase");
        ...
        var entity = mapper.Map<AddBaseDatabaseEntity>(request);
