...
/// <summary>
/// ViteCent.Database服务API程序入口类
/// </summary>
/// <remarks>
/// 该类负责配置和启动ViteCent.Database服务的Web API应用程序，主要功能包括：
...
public class Program
{
    ...
    /// <remarks>
    /// 主要完成以下初始化工作：
    /// 1. 配置XML文档路径，包括和ViteCent.Database的XML文档
    /// 2. 创建并配置微服务实例
    ...
    public static async Task Main(string[] args)
    {
        ...
        {
            "ViteCent.Core.*.xml",
            "ViteCent.Database.*.xml"
        };

        // 创建并配置微服务实例
        var microService = new BaseMicroService("ViteCent.Database.Api", xmls)
        {
            // 配置服务构建
            OnBuild = builder =>
            {
