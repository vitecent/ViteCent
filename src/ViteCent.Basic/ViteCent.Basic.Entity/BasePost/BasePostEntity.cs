...
/// </summary>
[Serializable]
[SugarTable("base_post")]
public class BasePostEntity : BaseEntity, IRequest<BaseResult>
{
    /// <summary>
    /// 简称
    /// </summary>
    ...
    /// 上班时段
    /// </summary>
    [SugarColumn(ColumnName = "times", ColumnDataType = "varchar", Length = 500, ColumnDescription = "上班时段")]
