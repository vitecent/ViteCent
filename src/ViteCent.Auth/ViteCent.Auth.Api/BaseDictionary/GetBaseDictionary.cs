...
public partial class GetBaseDictionary(
    // 注入日志记录器
    ...
    IMediator mediator)
    // 继承基类，指定查询参数和返回结果类型
    : BaseApi<GetBaseDictionaryArgs, DataResult<BaseDictionaryResult>>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    /// 4. 返回查询结果
    /// </remarks>
    /// <param name="args">查询参数，包含获取字典信息所需的条件</param>
    /// <returns>返回包含字典信息的数据结果对象</returns>
