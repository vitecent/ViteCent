...
public class AddBasePositionList(
    ...
    IMediator mediator)
    // 继承基类，指定查询参数和返回结果类型
    : BaseListApi<List<AddBasePositionArgs>, BaseResult>
{
    /// <summary>
    /// 用户信息
    /// </summary>
    ...
    // 设置路由名称
    [Route("AddList")]
    public override async Task<BaseResult> InvokeAsync(List<AddBasePositionArgs> args)
    {
        // 记录方法调用日志，便于追踪和调试
        ...
        // 构建请求参数
        var request = new AddBasePositionListArgs()
        {
            Items = args
        };
