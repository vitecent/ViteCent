...
/// 批量新增资源信息领域服务类
/// </summary>
/// <remarks>该类负责处理批量新增资源信息的业务逻辑 继承自 BaseDomain 基类并实现 IRequestHandler 接口 通过依赖注入方式接收日志记录器，用于记录操作日志</remarks>
    ...
    : BaseDomain<AddBaseResourceEntity>, IRequestHandler<AddBaseResourceEntityListArgs, BaseResult>
{
    ...
    /// <param name="request">包含要新增的资源信息列表的请求参数</param>
