...
public class PageBaseResource(
    ...
    // 继承基类，指定查询参数和返回结果类型
    : BaseDomain<BaseResourceEntity>, IRequestHandler<SearchBaseResourceEntityArgs, List<BaseResourceEntity>>
{
    /// <summary>
    /// 数据库名称
    /// </summary>
