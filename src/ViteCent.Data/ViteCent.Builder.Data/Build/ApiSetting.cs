...
public class ApiSetting
{
    /// <summary>
    /// </summary>
    public string Cache { get; set; } = "192.168.0.8:6379,password=123456,defaultDatabase=1";
    ...
    /// <summary>
    /// </summary>
    public string Register { get; set; } = "http://192.168.0.8:8500";

    /// <summary>
    /// </summary>
    public string ServiceAddress { get; set; } = "192.168.0.8";
    ...
    /// <summary>
    /// </summary>
    public string Trace { get; set; } = "http://192.168.0.8:9411/api/v2/spans";
}